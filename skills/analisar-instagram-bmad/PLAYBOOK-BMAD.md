...
1. **Dados publicos**: leitura direta do perfil publico (bio, posts visiveis, contagens), processada por Gemini com prompts BMAD.
...
5. **Velocidade**: 3 a 5 minutos do @username ao link entregue.
